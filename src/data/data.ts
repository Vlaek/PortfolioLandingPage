...
export const skills = [
  ...
  },
  {
    title: 'Java',
    type: ['Backend'],
    extra: ['Spring Boot', 'Hibernate', 'Lombok'],
  },
  {
    title: 'Python',
    type: ['Backend'],
    extra: ['Flask', 'Keras', 'Matplotlib', 'NumPy', 'Pandas'],
  },
  {
    title: 'Git',
...
export const experiences = [
  ...
  },
  {
    ...
    tasks: [
      ...
      'Fixing backend endpoints in Java to ensure correct performance',
      'Fixing bugs in application logic and interface errors',
      'Participating in the code review and maintaining a high coding standard',
      'Participate in team meetings and discussions to share ideas and optimize workflow',
